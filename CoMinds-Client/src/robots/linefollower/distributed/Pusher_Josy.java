...
/**
 * This robot is connected to an object on the LEFT side and will move this
 * object along a line. -> distance must be negative
 * 
 * @author Annabelle Klarl
 */
public class Pusher_Josy extends Pusher {

	@SuppressWarnings("unused")
	private static final Logger logger = Logger.getLogger("log_left.txt",
	 ...
	 */
	public Pusher_Josy(RemoteColorSensorWrapper light, float distance,
			boolean reverse) {
	 ...
	 *            whether the driving direction should be reversed
	 */
	public Pusher_Josy(BotProperties properties, PIDProperties pidProperties,
	...
	public static void main(String[] args) {
		try {
			...
			// main(new Pusher_Josy(props, props, new RemoteLightWrapper(true,
			// "Jamy", 0), distance, true));
			main(new Pusher_Josy(props, props, new RemoteColorSensorWrapper(
